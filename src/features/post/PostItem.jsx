...
export default function PostItem({ data }) {
  return (
    <div className="flex flex-col h-full rounded-lg border border-gray-200 overflow-hidden bg-white shadow-sm hover:shadow-md transition-shadow duration-200">
      {/* Gambar: gunakan aspect-ratio agar proporsional */}
      <div
      ...
      <div className="flex flex-col p-3 flex-1">
        ...
        <div className="text-[13px] text-gray-600 leading-relaxed text-justify line-clamp-4 flex-1">
